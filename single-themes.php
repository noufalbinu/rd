...
<div class="theme-single-container-wrap container-width-1100">
  ...
  <div class="theme-sidebar">
    ...
    <div class="project-buttons">
      <a class="download-cta cta-free" href="<?php echo esc_attr( get_post_meta( get_the_ID(), 'free_download', true ) ); ?>">Download Free</a>
      <a class="download-cta cta-pro" href="<?php echo esc_attr( get_post_meta( get_the_ID(), 'hcf_author', true ) ); ?>">Download PRO</a>
