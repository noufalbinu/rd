    ...
    <div id='footer-container'>
      <div id='section-3'>
          ...
          <div class='links'>
            <h3>Site Links?</h3>
            <ul>
             <li><a href='https://wpadroit.com/docs'>Documentation</a></li>
             <li><a href='https://wpadroit.com/support'>Support</a></li>
            </ul>
          </div>
          <div class='links'>
...
<script>
  ...
  closeOpen.addEventListener('click', () => {
    if(searchIcon.classList.contains('close-icon')) {
      searchIcon.classList.remove("close-icon")
      searchIcon.reset()
    } else {
      searchIcon.reset()
      document.querySelector("#search-form").className = "close-icon";  
    }
  })
</script>
</body>
